...
Открываешь стрим на YouTube и хочешь быстро ответить конкретному человеку в чате. Но вместо удобного ответа приходится совершать кучу лишних действий: переключаешься на английский, ставишь собаку, набираешь ник, пробел, снова переключаешься на русский и только потом пишешь комментарий... Это жутко раздражает, особенно на динамичных трансляциях с быстрым потоком сообщений, где каждая секунда на счету! Иной раз, даже думаешь, "а может ну его нафиг"?

Этот скрипт полностью решает проблему. Больше никакого жмаканья по лишним кнопкам и меню — теперь ответить любому зрителю можно мгновенно!

### Как это работает:
1. Просто **кликните левой кнопкой мыши прямо по никнейму** любого пользователя в чате стрима.
2. Скрипт мгновенно перехватит клик и сразу подставит правильный тег пользователя в ваше поле ввода (@Имя_Зрителя)!
3. При этом курсор автоматически прыгнет в самый конец строки, и скрипт сам, заботливо, добавит пробел — вам останется только набрать свой текст и нажать Enter!

### Преимущества:
* **Ультра-скорость:** Больше не нужно совершать кучу действий ради одного ответа. Всё происходит в один клик.
* **Идеальный внешний вид:** Скрипт защищен от бага с двойными собаками (`@@`). Тег всегда будет чистым и аккуратным.
* **Родное меню не сломано:** Если вам всё-таки нужно заблокировать или пожаловаться на пользователя, просто нажмите на три точки справа от сообщения или на его аватарку — стандартное меню YouTube откроется без проблем.
